describe('Automation - File Upload Example - 3', function () {

    it.only('Cypress Test Case - Understanding upload file - 3', function () {
    ...
    //  cy.fileupload('//*[@id="file-upload"]','module1/test.txt')
      ...
      cy.get('#uploaded-files').contains('pink nature image.jpg')
    ...
    //   it('Cypress Test Case - Understanding Download file - PDF ', function () {
